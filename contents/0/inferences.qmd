...
::: {#def-}
# Statistics
Let $X_1,\ldots,X_n$ denote a sample on a random variable $X$. Let $T=T(X_1,\ldots,X_n)$ be a function of the sample. $T$ is called a **statistic**. Once the sample is drawn, $t=T(x_1,\ldots,x_n)$ is called the realization of $T$.
:::
